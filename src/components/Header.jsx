    ...
    <header className={styles.burger__container}>
      ...
      <nav className={styles.nav__header}>
        <ul>
          ...
          <li>
            <NavLink to="/projects">Portafolio</NavLink>
          </li>
          <li>
            <NavLink to="/skills">Habilidades</NavLink>
          </li>
          <li>
            <NavLink to="/testimonials">Contacto</NavLink>
          </li>
        </ul>
      </nav>
    ...
    <Fragment>
      <header className={styles.header}>
        ...
        <div className={styles.icons}>
          ...
          <a href="https://www.facebook.com/profile.php?id=100009566345222" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="https://github.com/AlbertoLcm" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
